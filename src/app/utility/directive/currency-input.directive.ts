...
import {Directive, HostListener, ElementRef, OnInit, Input, numberAttribute} from "@angular/core";
...
export class CurrencyInputDirective implements OnInit {
  ...
  ngOnInit() {
    this.el.value = <string>this.currencyPipe.transform(this.el.value, 'PLN ');
  }
  ...
  onBlur(value: any) {
    ...
    this.el.value = <string>this.currencyPipe.transform(value, 'PLN ');
  }
